...
let form =document.getElementById("form");
    ...
    //The document object is a property of the window object. The window object represents the browser window. 
    //The document object represents the HTML document loaded in that window.

let year = document.getElementById("Dates");    
    year.style.color=("red");
    year.style.width=("100px");
    year.style.height=("30px");
